...
const BonusCard = ({bonusInfo}) => {
  return (
    <>
      <div>
        <div className={style["bonus__quantity"]}>
          {bonusInfo.currentQuantity} бонусов
        </div>
        <div className={style["bonus__burning"]}>
          {bonusInfo.dateBurning} сгорит{" "}
          <svg
      ...
      <span className={style["bonus__details"]}>
        <svg
          width="35"
          height="35"
          viewBox="0 0 35 35"
